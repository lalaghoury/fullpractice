...
const Comments = ({ comments, onUpdateComments, used }) => {
  ...
  const handleReply = async (commentId) => {
    try {
      ...
      await axios.post(
        `https://tense-woolens-bass.cyclic.app/comments/${commentId}/reply`,
        newComment
      );
      onUpdateComments();
      setCommentBody("");
  ...
  const handleDelete = async (commentId) => {
    try {
      await axios.delete(
        `https://tense-woolens-bass.cyclic.app/comments/${commentId}`
      );
  ...
  const handleUpdate = async (commentId) => {
    try {
      await axios.put(
        `https://tense-woolens-bass.cyclic.app/comments/${commentId}`,
        { content: commentBody, updatedAt: new Date() }
      );
